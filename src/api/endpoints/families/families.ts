...
const removeMemberApiV1FamiliesFamilyIdMembersUserIdDelete = (
  ...
  /**
 * POST /families/{familyId}/leave — any member leaves voluntarily.
 * @summary Leave Family
 */
const leaveFamilyApiV1FamiliesFamilyIdLeavePost = (
    familyId: string,
 ) => {
      return customInstance<MemberResponse>(
      {url: `/api/v1/families/${familyId}/leave`, method: 'POST'
    },
      );
    }
  /**
...
export type LeaveFamilyApiV1FamiliesFamilyIdLeavePostResult = NonNullable<Awaited<ReturnType<ReturnType<typeof getFamilies>['leaveFamilyApiV1FamiliesFamilyIdLeavePost']>>>
